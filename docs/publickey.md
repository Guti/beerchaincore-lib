# Public Key
Represents a Beerchain public key and is needed to be able to receive Beerchain, as is usually represented as a Beerchain [Address](address.md). 

A PublicKey in beerchaincore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new beerchaincore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = beerchaincore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
